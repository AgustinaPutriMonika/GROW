...
if (isset($_POST['login'])) {
    ...
    if (cekLogin($username, $password)) {
        $_SESSION['log'] = True;
        $data = getDataLogin($username, $password);
...
//     $login = mysqli_query($koneksi,"SELECT * FROM user WHERE nama='$username' and id_user='$password'");
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4"><img src="assets/img/Grow.jpeg" width="180" height="120" alt="logotoko"></h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    if (isset($_GET['pesan'])) {
