                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="login.php">Hasil Absensi</a>
                                </nav>
                        </div>
                    </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php 
                                            $ambilsemua = mysqli_query($koneksi, "SELECT * FROM masuk_toko JOIN produk ON masuk_toko.kd_jual = produk.kd_jual JOIN toko ON masuk_toko.id_toko = toko.id_toko;" );
                                            $no=1;
                                            $totalb20 = 0;
