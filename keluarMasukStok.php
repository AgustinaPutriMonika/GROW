                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php 
                                        $ambilsemua = mysqli_query($koneksi, "SELECT * FROM carry_produk JOIN produk ON produk.id_produk = carry_produk.id_produk JOIN user ON user.id_user = carry_produk.id_user;" );
                                        $no=1;
                                        while($data = mysqli_fetch_array($ambilsemua)){
                                            $tanggal = $data['tanggal_carry'];
                                            $nama = $data['nama'];
                                            $nama_produk = $data['nama_produk'];
                                            $stok_dibawa = $data['stok_dibawa'];
                                            $stok_kembali = $data['stok_kembali'];
                                    ?>
                                    <tr>
                                    <td><?=$no++;?></td>
                                    <td><?=$tanggal;?></td>
                                    ...
                                    <td><?=$stok_dibawa;?></td>
                                    <td><?=$stok_kembali;?></td>
                                    <td><button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editkm">
                                               Order
                                        </button></td>
                                    </tr>
